...
Promise.all([
  ...
  const instanceCount = data.byteLength / bytesPerVertex
  ...
  const updateColorDestState = dlite({
    vertexArray: dlite.createVertexArray()
      .vertexAttributeBuffer(0, buffer, { type: dlite.gl.FLOAT, size: 2, stride: bytesPerVertex, offset: 8 * 4 })
      .vertexAttributeBuffer(1, buffer, { type: dlite.gl.FLOAT, size: 1, stride: bytesPerVertex, offset: 10 * 4 })
      .vertexAttributeBuffer(2, buffer, { type: dlite.gl.FLOAT, size: 1, stride: bytesPerVertex, offset: 11 * 4 })
      .vertexAttributeBuffer(3, buffer, { type: dlite.gl.FLOAT, size: 1, stride: bytesPerVertex, offset: 12 * 4 }),
    vs: `#version 300 es
  ...
  const arcRenderer = createArcRenderer(dlite, {
    origins: [buffer, { type: dlite.gl.FLOAT, size: 3, stride: bytesPerVertex, offset: 2 * 4 }],
    destinations: [buffer, { type: dlite.gl.FLOAT, size: 3, stride: bytesPerVertex, offset: 5 * 4 }],
